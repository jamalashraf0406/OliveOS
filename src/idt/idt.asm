...
%macro interrupt 1
    ...
    int%1:
        ...
        ; ALERADY PUSHED TO US BY THE PROCESSOR UPON ENTRY TO THIS INTERRUPT
        ; uint32_t ip
        ; uint32_t cs
        ; uint32_t flags
        ; uint32_t sp
        ...
        pushad 
        ; Interrupt the general purpose registers to the stack
        push esp
        push dword %1
...
isr80h_wrapper:
    ...
    ; Restore genreal purposes for usre land
    popad
    mov eax, [tmp_res]
    iretd
