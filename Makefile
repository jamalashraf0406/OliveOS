FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/gdt/gdt.asm.o ./build/gdt/gdt.o ./build/loader/formats/elf.o ./build/loader/formats/elfloader.o ./build/memory/memory.o ./build/io/io.asm.o ./build/task/tss.asm.o ./build/task/task.asm.o ./build/task/task.o ./build/keyboard/keyboard.o ./build/keyboard/classic.o ./build/isr80h/isr80h.o ./build/isr80h/heap.o ./build/isr80h/misc.o ./build/isr80h/io.o ./build/isr80h/process.o ./build/task/process.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o ./build/disk/streamer.o ./build/fs/pparser.o ./build/string/string.o ./build/fs/file.o ./build/fs/fat/fat16.o
INCLUDES = -I./src
...
all: ./bin/boot.bin ./bin/kernel.bin user_programs
	...
	# Below cmd is for copy file in our os
	sudo cp ./hello.txt /mnt/d
	sudo cp ./programs/blank/program.elf /mnt/d
